...
})({"61NJ6":[function(require,module,exports,__globalThis) {
...
parcelHelpers.export(exports, "setupEvents", ()=>setupEvents);
var _calculatorJs = require("./calculator.js");
function setupEvents() {
    const myCalc = new (0, _calculatorJs.Calculator)();
...
},{"./calculator.js":"hfT1R","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hfT1R":[function(require,module,exports,__globalThis) {
// export function calculate(expression) {
//     try {
//         if (expression.includes("√")) {
//             return Math.sqrt(parseFloat(expression.split("√")[1]));
//         } else if (expression.includes("^")) {
//             const [base, exp] = expression.split("^").map(Number);
//             return Math.pow(base, exp);
//         } else {
//             return eval(expression); // Note: Use a safer parser in production.
//         }
//     } catch (error) {
//         return "Error";
//     }
...
class Calculator {
   ...
   * @returns numA + numB
   */ add(numA, numB) {
        if (isNaN(numA) || isNaN(numB) || typeof numA !== "number" || typeof numB !== "number") throw new Error("Invalid input: Both arguments must be valid numbers.");
        return numA + numB;
    }
    /**
   *
...
},{}]},["61NJ6","9f5IL"], "9f5IL", "parcelRequireff1f")

//# sourceMappingURL=Calculator.3052eed7.js.map
